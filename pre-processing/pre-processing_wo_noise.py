...
frames = [df_training_fm_part_1, df_training_fm_part_2]
...
frames = [df_training_fa_part_1, df_training_fa_part_2]
...
frames = [df_training_sc_part_1, df_training_sc_part_2]
...
frames = [df_training_sh_part_1, df_training_sh_part_2]
...
df_training_fm.to_csv('df_face_masks_train_preprocessed_wo_noise.tsv', sep="\t", encoding = 'utf-8')
df_test_fm.to_csv('df_face_masks_test_preprocessed_wo_noise.tsv', sep="\t", encoding = 'utf-8')

df_training_fa.to_csv('df_fauci_train_preprocessed_wo_noise.tsv', sep="\t", encoding = 'utf-8')
df_test_fa.to_csv('df_fauci_test_preprocessed_wo_noise.tsv', sep="\t", encoding = 'utf-8')

df_training_sc.to_csv('df_school_closures_train_preprocessed_wo_noise.tsv', sep="\t", encoding = 'utf-8')
df_test_sc.to_csv('df_school_closures_test_preprocessed_wo_noise.tsv', sep="\t", encoding = 'utf-8')

df_training_sh.to_csv('df_stay_at_home_orders_train_preprocessed_wo_noise.tsv', sep="\t", encoding = 'utf-8')
df_test_sh.to_csv('df_stay_at_home_orders_test_preprocessed_wo_noise.tsv', sep="\t", encoding = 'utf-8')